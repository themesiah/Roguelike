...
namespace Laresistance.Tests
{
    public class Player_Minion_Tests
    {
        ...
        //    Minion minion = new Minion(null, new BattleAbility[] { GetAbility() }, 1);
        ...
        //{
        //    Player player = new Player(new Battle.BattleStatusManager(new Battle.CharacterHealth(100)));
        //    Minion minion1 = new Minion(null, new BattleAbility[] { GetAbility() }, 1);
        //    bool equipped = player.EquipMinion(minion1);
        //    Assert.AreEqual(true, equipped);
        //    Minion minion2 = new Minion(null, new BattleAbility[] { GetAbility() }, 1);
        //    equipped = player.EquipMinion(minion2);
        //    Assert.AreEqual(true, equipped);
        //    Minion minion3 = new Minion(null, new BattleAbility[] { GetAbility() }, 1);
        ...
        //    equipped = player.EquipMinion(minion3);
        //    Assert.AreEqual(true, equipped);
        //    Minion minion4 = new Minion(null, new BattleAbility[] { GetAbility() }, 1);
